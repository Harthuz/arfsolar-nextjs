...
export default function VRF() {
  ...
  const slides = [
    { id: 1, type: "image", name: "IMG-20260628-WA0013.jpg", path: "/imgs/vrf/IMG-20260628-WA0013.jpg", desc: "Instalação de unidades condensadoras VRF em cobertura técnica." },
    { id: 2, type: "image", name: "IMG-20260628-WA0014.jpg", path: "/imgs/vrf/IMG-20260628-WA0014.jpg", desc: "Interligação elétrica e frigorígena de sistema VRF." },
    { id: 3, type: "image", name: "IMG-20260628-WA0015.jpg", path: "/imgs/vrf/IMG-20260628-WA0015.jpg", desc: "Equipamentos evaporadores cassete embutidos de forma moderna." },
    { id: 4, type: "image", name: "IMG-20260628-WA0016.jpg", path: "/imgs/vrf/IMG-20260628-WA0016.jpg", desc: "Controle centralizado inteligente de climatização VRF." }
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <h2 className="text-2xl font-bold text-[#0468BF]">
              Comercialização e Distribuição de Sistemas VRF
            </h2>
            <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
              A <b>ARF Solar</b> comercializa ar condicionados VRF (Variable Refrigerant Flow). Trabalhamos com quipamentos para climatização de edifícios de médio e grande porte.
            </p>
            ...
            <div className="space-y-4 pt-4 border-t border-slate-100">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-bold text-slate-800">
                  Distribuição direta das maiores marcas e fabricantes mundiais.
                </span>
              </div>
            </div>
            ...
            <div className="pt-4">
              <a
                href="https://wa.me/5511947769974?text=Olá!%20Gostaria%20de%20fazer%20um%20orçamento%20para%20compra%20de%20equipamentos%20VRF."
                target="_blank"
              ...
              >
                Solicitar Orçamento de Compra de VRF
              </a>
            </div>
          </div>
